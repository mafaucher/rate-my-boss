<!-- START OF MAIN -->
	...
	?>
		...
		or supervisors, post reviews, rate an organization, or upload documents. In order
		to assure your anonymity, we do not, and will never, ask you personal questions.
		Your username is used to login, and will never be used to identify your posts.
		Creating an account will allow you to update your posts later on. We do this by
		giving you a unique, random string of characters which you can use to edit your posts.</p>
